...
public final class PurchaseOrderReceiptNone extends GuidKeyEntityNone<PurchaseOrderReceiptNone> implements PurchaseOrderReceipt {
	...
	@Override
	public void update(LocalDate paymentDate, String object, double paidAmount, PaymentMode mode,
