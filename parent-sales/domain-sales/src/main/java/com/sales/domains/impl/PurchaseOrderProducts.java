...
public class PurchaseOrderProducts implements OrderProducts {

	private transient final OrderProducts origin;
	
	public PurchaseOrderProducts(final OrderProducts origin){
		this.origin = origin;
	}
	...
	public OrderProduct build(UUID id) {
		return new PurchaseOrderProduct(origin.build(id));
	}
